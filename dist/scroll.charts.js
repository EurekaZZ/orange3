$(document).ready(function () {
	...
	new ScrollMagic.Scene({
        triggerElement: "#countries-p0",
        triggerHook: 0.8
    })
        .setClassToggle("#countries00000", "fadeout")
        .addTo(controller)
...
$(document).ready(function () {
    var cloud1Width = $("#cloud1").width();
    var cloud1Height = $("#cloud1").height();
    var cloudtextHeight = $("#cloud-text").height();
    var fixedHeight = cloudtextHeight;

    $("#cloud").css("width", cloud1Width);



    var controller = new ScrollMagic.Controller();
    new ScrollMagic.Scene({
        triggerElement: "#cloud-imgs",
        triggerHook: 0,
        duration: fixedHeight
    })
        .setPin("#cloud-imgs")
	...
	new ScrollMagic.Scene({
        triggerElement: "#cloud-p1",
        triggerHook: 0.8
    })
        .setClassToggle("#cloud1", "fadeout")
        .addTo(controller)

    new ScrollMagic.Scene({
        triggerElement: "#cloud-p2",
        triggerHook: 0.7
    })
        .setClassToggle("#cloud2", "fadeout")
        .addTo(controller)

    new ScrollMagic.Scene({
        triggerElement: "#cloud-p3",
        triggerHook: 0.7
    })
        .setClassToggle("#cloud3", "fadeout")
        .addTo(controller)
